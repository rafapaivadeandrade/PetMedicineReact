...
import '../css/appointmentlistitem.css';
...
export default class ListAppointments extends Component{
    ...
    return( 
        ...
        {this.props.apts.map(item => (
            <div className="pet-item col media py-3" key={item.aptId}>
          <div className="mr-3">
            <button className="pet-delete btn btn-sm btn-danger" 
            onClick= {() => { 
              //this.props.deleteAppointment2(item)
          ...
          <div className="pet-info media-body">
            <div className="pet-head d-flex">
              <span className="pet-name" contentEditable suppressContentEditableWarning onBlur={
