...
export default class AddAppointments extends Component{
    ...
    render(){
    return(
        <div className='card textcenter mt-3' style= {this.divStyle}>
        ...
        <div className="card-body" style= {this.divbodystyle}>
          <form id={(this.props.formDisplay?'':'aptForm')} noValidate
